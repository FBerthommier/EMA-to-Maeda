"""Supplementary Figure S4 of the article: CTW alignment of one Maeda
reference model onto another (Model15 aligned onto Model12).

Shows the reference Model12 parameters with the CTW-aligned Model15
parameters overlaid, and prints the Pearson correlations between
Model12/Model15 and the aligned signals.

Original script: SynthsylShort/FigureS4.py
"""
...
def main():
    """Build Figure S4: Model15 CTW-aligned onto Model12."""
    ...
    axes[0].legend(["Model12", "CTW Model15"], ncol=2, loc="upper left")

    print_correlations(ema_data1, ema_data2, ema_data3, fname1, fname2)

    save_figure(fig, "figs4_ctw_model15_on_model12.png")
    plt.show()
