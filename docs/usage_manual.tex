...
communication, 2026). See \texttt{CITATION.cff}. \textbf{TODO-FINALIZATION:}
insert the Zenodo DOI, the arXiv identifier and the official
Interspeech-style reference once the three deposits are finalized.
